...
import { pdfToWord } from '@/lib/pdf/converter';
import { getFileSize } from '@/lib/utils/fileHandler';
import fs from 'fs';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const outputFilename = (file.originalFilename || 'converted').replace('.pdf', '.docx');
